    ...
    public class PortableWorldMenu : UdonSharpBehaviour
    {
        ...
        public void _spawnMenu(bool isVR, bool useSound)
        {
            ...
            else
            {
                ...
                DesktopTargetPosition.localPosition = new Vector3(0f, 0.04f * detectedScale, 0.55f * detectedScale);
        ...
        private void _sendDebugLog(string log) => Debug.Log("<b> [Reava/UwUtils/PortableWorldMenu.cs]: " + log + " on: " + gameObject.name + ".</b> ", gameObject);
        private void _sendDebugWarning(string errorReported) => Debug.LogWarning("<color=white> [Reava/UwUtils/PortableWorldMenu.cs]:<color=orange> <b>" + errorReported + "</b></color>, this will be ignored when functioning. <color=orange>Check References <color=white>/</color> Settings</color> on: " + gameObject.name + ".</color>", gameObject);
        private void _sendDebugError(string errorReported) => Debug.LogError("<color=white> [Reava/UwUtils/PortableWorldMenu.cs]:<color=red> <b>" + errorReported + "</b></color>, please review <color=orange>References <color=white>/</color> Settings</color> on: " + gameObject.name + ".</color>", gameObject);
